...
export default class Command extends BaseCommand {
    ...
    run = async (M: ISimplifiedMessage): Promise<void> => {
        const n = [
            'https://telegra.ph/file/060b6d232771a1a299f8b.mp4'
        ]
...
📮 *Q1:* How do I add Mai san bot in my group?
...
📮 *Q6:* Where can I find Mai san bot?
📑 *A:* Mai san is one of the bots owned by *akuma*. Incase you need other bots, use the command *!support* & you will get support group link in your DM.
ᚖ ────── ✪ ────── ᚖ
...
📮 *Q9:* How can I create a bot like Mai san?
📑 *A:* You can't deploy a version of Mai san thus it's a copy of Chitoge, edited & added with some commands resulting the bot to be a private source. Therefore, you can deploy the main bot *(NATSU)* here👇
 🎗 https://github.com/.
ᚖ ────── ✪ ────── ᚖ
